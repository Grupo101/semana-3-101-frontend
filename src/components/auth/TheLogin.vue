...
<div class="container mt-5">
	...
	<section id="content">
		<form action="">
			<h1>Login Grupo 101 </h1>
			<div>
				<input v-model="login.email" type="text" placeholder="Username" required="" id="username" />
			</div>
			<div>
				<input v-model="login.password" type="password" placeholder="Password" required="" id="password" />
			</div>
